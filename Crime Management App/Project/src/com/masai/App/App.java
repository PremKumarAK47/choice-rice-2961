...
public class App {
	...
	public static void main(String[] args) throws SQLException, CriminalException, Police_StationException {
		...
		try {
			System.out.println("*****Crime Management System Application*****");
			System.out.println(
					"===============================================");
			...
			while (true) {
				...
				System.out.println(" "
						+"  \n Press  1. Log In Officer : "
						+ " \n Press  2. View All Criminals Data  : "
						+ " \n Press  3.  Enter Criminal Id to search to Criminal data : "
						+ " \n Press  4.  Enter For Update of Criminal data  : "
						...
						+ " \n Press  9.  Enter Criminal Id to Delete  : "
...
/*
                          *****Crime Management System Application*****
==================================================================================================================
...
===================================================================
1
                               Login as Assistant Police Inspector  
                            ===============================================
Enter Username:
